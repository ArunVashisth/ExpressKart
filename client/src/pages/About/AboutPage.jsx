          ...
          <div className="container-custom text-center">
            ...
            <div className="mt-12 pt-8 border-t border-gray-700">
              <div className="grid md:grid-cols-3 gap-8 text-left max-w-4xl mx-auto">
                <div>
                  <h4 className="text-white font-medium mb-3 hover:text-[var(--vibe-accent)] cursor-pointer">
                  ...
                  <div className="space-y-2 text-gray-300 text-sm">
                    ...
                    <div className="flex items-center">
                      ...
                      <a href="tel:+919205601869">+91 9205601869</a>
                    </div>
                    <div className="flex items-center">
                      <EnvelopeIcon className="w-4 h-4 mr-2 text-orange-500" />
                      <a href="mailto:Arunvashisth80@gmail.com">Arunvashisth80@gmail.com</a>
                    </div>
                  </div>
                </div>
